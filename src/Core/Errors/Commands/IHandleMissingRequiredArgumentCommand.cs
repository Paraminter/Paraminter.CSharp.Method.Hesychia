...
/// <summary>Represents a command to handle an error encountered when associating C# method arguments with parameters, caused by missing a required argument.</summary>
